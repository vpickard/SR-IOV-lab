...
#Emulated HWVTEP-2
HWVTEP2_TUNNEL_IP      = "192.168.254.95"
HWVTEP2_TUNNEL_GATEWAY = "192.168.254.254"
HWVTEP2_MGMT_IP        = "10.8.125.242"
HWVTEP2_VLAN_IP        = "192.168.220.95"
HWVTEP2_VLAN_IP2       = "192.168.230.95"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # HWVTEP-2
  config.vm.define "hwvtep2" do |hwvtep2|
    hwvtep2.vm.hostname = "hwvtep2"

    # Tunnel transport network
    hwvtep2.vm.network "private_network",
                      :libvirt__network_name => 'vxlan_net',
                      :libvirt__forward_mode => 'none',
                      ip: HWVTEP2_TUNNEL_IP,
                      netmask: "255.255.255.0"
    ...
    # tap for eth2, that will be connected to ovs bridge hwvtep2br
    hwvtep2.vm.network :public_network,
                      :mode => 'bridge',
                      :dev => 'hwvtep2br',
                      :type => 'bridge',
                      :ovs => true,
    ...
    hwvtep2.vm.provider "libvirt" do |lv|
      lv.memory = 2048
      lv.cpus = 2
    end

    hwvtep2.vm.provision "puppet" do |puppet|
      puppet.manifests_path = "puppet/manifests"
      puppet.manifest_file  = "site.pp"
      puppet.options = "--verbose --debug"
    end
